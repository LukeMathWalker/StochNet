...
from stochnet.utils.conversion import convert_from_numpy_to_hdf5
...
filepath_for_saving ='/home/lucap/Documenti/Data storage/SIR_dataset_medium.hdf5'
convert_from_numpy_to_hdf5(np_X_data, np_y_data, filepath_for_saving)
