...
training_generator = HDF5Iterator(dataset_address, batch_size=64, shuffle=True)
validation_generator = HDF5Iterator(test_dataset_address, batch_size=64, shuffle=True)
